...
--
-- Name: appointments customer_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: appointments service_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
